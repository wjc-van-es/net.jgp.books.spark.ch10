...
public class ReadRecordFromMultipleFileStreamApp {
    ...
    private void start() throws TimeoutException {
        ...
        // Two subdirectories
        // Improvement: Both this class and net.jgp.books.spark.ch10.x.utils.streaming.app.RecordsInFilesGeneratorApp
        // use the same subDirs generated by StreamingUtils
        String landingDirectoryStream1 = StreamingUtils.getInputSubDirectory1();
        String landingDirectoryStream2 = StreamingUtils.getInputSubDirectory2();
